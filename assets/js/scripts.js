...
$(window).load(function() {
    ...
    $('.socket').addClass('animated fadeOut');
      ...
      setTimeout(function() {
          ...
          setTimeout(function() {
              $('.block-content img.logo').addClass('animated fadeInDown');

              setTimeout(function() {
                  $('.fade').addClass('animated fadeInUp');

                  setTimeout(function() {
                      $('.block-social').addClass('animated fadeInUp');

                      setTimeout(function() {
                          $('.block-drop').addClass('animated fadeInUp');
                          ...
                          setTimeout(function() {
                              ...
                              setTimeout(function() {
                                  ...
                                  $('.block-drop').css('opacity','1');
                                  $('.block-social').css('opacity','1');
                                  $('.fade').css('opacity','1');
                                  $('.block-content img.logo').css('opacity','1');
